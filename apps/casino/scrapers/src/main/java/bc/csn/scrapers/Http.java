...
public final class Http {
    ...
    public String downloadTextFile(final URL url) throws IOException {
    ...
    public String downloadCriticalTextFile(URL url) throws CriticalException {
        String pageContents = "";
