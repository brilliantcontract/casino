...
/**
 * Fetch data from 9 table every 60 seconds. Test duration is 2 hours.
 */
@Ignore
public class Performance2Test {
    ...
    private static final Integer PAUSE_MS = 60_000;
    private static final Integer ITERATIONS = 120;
